...
public class NoteTypeDao {
    ...
    public Integer checkTypeName(String typeId, String typeName, Integer userId) {
        ...
        if (noteType == null) {
            ...
            if ((noteType.getTypeId().toString()).equals(typeId)) {
                return 1;
            }
        }
        return 0;
     ...
     * @return
     */
    public static Integer addType(Integer userId, String typeName) {
        Integer key = null;
     ...
     * @return
     */
    public static Integer updateType(String typeId, String typeName) {
