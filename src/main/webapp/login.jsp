...
--%>
<%--isELIgnored="false" 是否忽略EL表达式，设置为false则可以识别EL表达式--%>
        ...
        <div id="tabcon">
            <div class="box show">
                <form action="user" method="post" id="loginForm">
                    <%--actionName表示用户行为，通过这个参数可以判断在Userservlet中判断用户当前想要进行操作的功能（行为：是登陆、
                    注册或是其他什么操作，这样不用写多个servlet，在一个servlet中操作就好）--%>
